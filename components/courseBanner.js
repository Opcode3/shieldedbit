...
export default function CourseBanner() {
  return (
    <div className="relative mt-4 md:mt-24 overflow-hidden shadow-xl flex flex-col items-center min-h-[650px] md:min-h-[450px] max-h-[950px] md:max-h-[550px] mx-auto w-[94%] rounded-md">
        ...
        <div className='absolute flex flex-col items-center bg-gradient-to-br from-blue-600/80 via-cyan-500/80 to-black/80 justify-center gap-y-2 h-full w-full'>
            ...
            <h2 className='text-2xl text-blue-50 mt-6 font-medium'>Course Value: <strong>$400,000.00</strong></h2>
            <div className=' mt-4 overflow-hidden'>
                <Link href=''>
                    <a className='py-3 px-7 uppercase text-center text-sm rounded inline-block bg-blue-50 hover:bg-blue-100 text-cyan-800'>Download Syllabus</a>
                </Link>
                <Link href=''>
                    <a className='py-3 px-7 uppercase text-center text-sm rounded ml-4 inline-block text-blue-50 hover:bg-cyan-900 bg-cyan-700'> Enroll Now</a>
                </Link>
            </div>
        </div>
    </div>
