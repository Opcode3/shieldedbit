  ...
  return (
    <div className="block">
        ...
        <div className="grid grid-cols-1 px-2">
          ...
          <Link href='./learn'><a className="bg-blue-600 hover:bg-black hover:text-blue-600 text-sm font-light transition-colors py-1 px-3 rounded w-fit">Start learning</a></Link>
        </div>
    </div>
  )
}
