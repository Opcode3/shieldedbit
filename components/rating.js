...
export default function Rating({rate = 3}) {
    let ratingInfo = [];
    for(let m = 0; m < 5; m++){
        ratingInfo.push((m < rate)? 1 : 0);
    }
  return (
