...
export default function Dashboard() {
  ...
  return (
    <div className=' bg-slate-300 clear-both'>
    <Head>
        <title>User Dashboard - ShieldedBit</title>
    </Head>
        <header className="w-full bg-gray-50 overflow-hidden md:overflow-visible md:top-0 relative md:fixed px-[2%] md:px-[3%] lg:px-[6%] min-h-[80px] border-b border-gray-200">
            <div className="w-full md:w-fit min-h-[80px] grid grid-cols-1 md:flex items-center float-left">
                <div className=" w-full md:w-fit flex justify-between items-center">
                    <img src='/assets/images/logo-black.png' className="w-20" alt="shieldedbit logo"/>
        ...
        <main className="min-h-[90vh] w-full bg-green-200 md:mt-[80px]">
            <h1 className="font-semibold">JESUS IS LORD</h1>
        </main>
        <Footer/>
    </div>
  )
